...
class PhysicsGuide:
    ...
    def compute_energy(self, z, contact_point_indices, verbose=False):
    ...
    def optimize(self, energy, grad, z, contact_point_indices, verbose_energy):
        ...
        # compute new energy
        new_linear_independence, new_force_closure, new_surface_distance, new_penetration, new_z_norm, new_normal_alignment = self.compute_energy(new_z, new_contact_point_indices, verbose=True)
    ...
    def refine(self, energy, grad, z, contact_point_indices, verbose_energy):
        linear_independence, force_closure, surface_distance, penetration, z_norm, normal_alignment = verbose_energy
        step_size = 0.1
        temperature = 1e-3
        # update z by langevin
